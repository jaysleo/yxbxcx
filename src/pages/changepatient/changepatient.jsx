...
import './changepatient.scss'
import netUtil from "../../utils/netUtil";
import Comm from "../../utils/Comm";


export default class Changepatient extends Component {
        ...
        <View>
...

          {
            this.state.patientArr.map((item, index) => {
              return(
                <View key={index} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'sapce-between', alignItems: 'center', backgroundColor: '#E8E8E8', padding: 10, margin: 10, borderRadius: 10 }}
                      onCLick={() => {
                  ...
                  <View style={{ marginRight: 5 }}>
                    {
                      Comm.currentPatiant.xunshupatient.id == item.xunshupatient.id &&
                      <AtIcon value='check' size='20' color='#00DE7B'></AtIcon>
                    }
                  </View>
                </View>
              );
